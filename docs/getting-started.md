...
```bash
git clone https://github.com/alexbalut/verdun-fitness-gym-qr-guide.git
...
Credentials: `admin@verdun-fitness.demo` / `demo1234`
...
Seed **wipes** gyms, users, machines, and issues, then recreates Verdun Fitness with 10 machines and sample issues/views.
